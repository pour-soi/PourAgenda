...
export function duePersonalReminderSlots(occurrence: AppointmentOccurrence, now: Date, windowMinutes = 5) {
...
export function personalReminderNotification(occurrence: AppointmentOccurrence) {
