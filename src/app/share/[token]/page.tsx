...
import { SharedAppointmentTime } from "@/components/shared-appointment-time";
  ...
  return <main className="min-h-dvh bg-background p-4 sm:p-8">
    <article className="mx-auto max-w-2xl rounded-xl border border-border bg-surface p-6 sm:p-8">
      ...
      <dl className="mt-6 space-y-4">
        <div><dt className="font-semibold">Date and time</dt><dd><SharedAppointmentTime start={item.starts_at} end={item.ends_at} timezone={item.timezone} /></dd></div>
